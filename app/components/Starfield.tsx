...
const StarfieldCanvas = () => {
    ...
    useEffect(() => {
        ...
        // All your existing functions here, but using canvas and ctx from refs
        const resizeCanvas = () => {
            if (!canvas) return;
        ...
        // Copy all other functions from script.js, but remove DOM queries
        // ... createStars, updateStars, drawStars, etc.
